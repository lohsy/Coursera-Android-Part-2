...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> rawTextFeedIds = getArguments().getIntegerArrayList(
				MainActivity.TAG_FRIEND_RES_IDS);
		Integer resourceIDS [] = new Integer[rawTextFeedIds.size()];
		resourceIDS = rawTextFeedIds.toArray(resourceIDS);
	...
	public class DownloaderTask extends AsyncTask<Integer[], Void, String[]> {
		...
		protected void onPostExecute(String[] strings) {
			//what happens if null, how to pass it back?
			//restartMainActivityIntent.putStringArrayListExtra(feeds);??
			if(mCallback != null)
